  ...
  board: {
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover: 'https://cdn-images.vtv.vn/zoom/640_400/562122370168008704/2023/12/4/photo1701716046802-1701716046992949859703.jpg',
      ...
      },
      {
         ...
         *
         * Quan trọng khi tạo : phải đầy đủ : ( id , boardId , columnId , FE_PlaceholderCard )
         *
         *** Kỳ hơn nữa về cách tạo chuẩn ở bước nào thì sẽ ở học phần tích hợp API Back-end vào dự án . ( bởi vì đây
        * là file mock-data )
        */
