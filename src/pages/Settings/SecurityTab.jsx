  ...
  const submitChangePassword = (data) => {
    confirmChangePassword({
      ...
      title: <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
        <LogoutIcon sx={{ color: 'warning.dark' }} /> Thay đổi mật khẩu
      </Box>,
      description: 'Bạn phải đăng nhập lại sau khi thay đổi thành công mật khẩu của mình. Tiếp tục?',
      ...
      toast.promise(
        ...
        if (!res.error) {
          toast.success('Mật khẩu đã thay đổi thành công, hãy đăng nhập lại')
