...
function AutoCompleteSearchBoard() {
  ...
  // Bọc hàm handleInputChange ở trên vào trong hàm useDebounceFn và cho delay khoảng 1s sau khi dừng gõ phím thì mới chạy cái function
  const deboundSearchBoard = useDebounceFn(handleInputSearchChange, 1000)
